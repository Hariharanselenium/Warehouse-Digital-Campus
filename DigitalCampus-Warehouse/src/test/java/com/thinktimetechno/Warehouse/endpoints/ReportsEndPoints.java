...
public class ReportsEndPoints extends BaseEndpoints{
		...
		public Response applicationSalesfetchPayload(String name ) {
			...
			case "get suppliers report":
				application_ENDPOINT_PATH="reports/suppliers?page=1&pageSize=10";
				break;
			case "get inventory-pricing report":
				application_ENDPOINT_PATH="reports/inventory-pricing?page=1&pageSize=20";
				break;
			...
			case "get purchases report":
				application_ENDPOINT_PATH="reports/purchases?startDate=2022-12-02&endDate=2022-12-02";
				break;
